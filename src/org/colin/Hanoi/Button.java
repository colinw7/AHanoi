...
class Button {
  ...
  private void update() {
    ...
    w_ = trect_.right  - trect_.left + 4;
    h_ = trect_.bottom - trect_.top  + 4;

    irect_ = new RectF(x_ - 4, y_ - h_ - 4, x_ + w_ + 4, y_ + 4);   
    orect_ = new RectF(x_ - 8, y_ - h_ - 8, x_ + w_ + 8, y_ + 8);
  ...
  public void draw(Canvas canvas) {
    ...
    path.lineTo(orect_.right - 8, orect_.top    + 8);
    path.lineTo(orect_.left  + 8, orect_.bottom - 8);
    ...
    canvas.drawText(str_, irect_.left + 4, irect_.bottom - 8, fg_paint_);
  }
